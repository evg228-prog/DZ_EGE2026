...
print([len(cluster) for cluster in clusters])
center_B_X = [center(cluster)[0] for cluster in clusters]
center_B_Y = [center(cluster)[1] for cluster in clusters]
print(sum(center_B_X) / len(center_B_X) * 100_000, sum(center_B_Y) / len(center_B_Y) * 100_000)
